...
const tabsData: TabData[] = [
    ...
    },
    {
        ...
        icon: <Star className="w-16 h-16 text-pink-500" />
    }
];
...
export default function TabBestIasCoachingCenter() {
    ...
    return (
        <>
            <div className='bg-slate-900 py-15 mb-10'>
              ...
              `}
                            ...
                            <div className="bg-white/6 border border-gray-100/20  rounded-2xl shadow-xl p-6 md:p-8 h-full flex flex-col justify-between min-h-[300px]">
                                ...
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
                                    <div className="flex-1 mb-4 md:mb-0 md:pr-6">
                                        <div className="inline-block bg-red-500 text-white px-4 py-2 rounded-full text-md font-bold mb-4">
                                            {activeTabData.cardTitle}
                                        </div>
                                        <p className="text-white leading-relaxed text-md md:text-base">
                                    ...
                                    <div className="flex-shrink-0">
                                        <div className="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-6 transition-transform duration-300">
                                            {activeTab === 'journey' ? (
                                                <div className="text-center">
                                                    <div className="text-2xl md:text-3xl font-bold text-white">20</div>
                                                    <div className="text-xs text-white opacity-90">YEARS</div>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-500 lg:hidden">
                        <p>Swipe or tap tabs above to explore different features</p>
                    </div>
                </div>
            </div>
        </>
