                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-0'>
                        ...
                        <div>
                            <div className='content md:pl-4 pt-4 text-center md:text-start'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'>Our Vision</h3>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center text-center md:text-left px-2 md:px-0'>
                        <div>
                            <div className='content md:pr-4 pt-4'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'>Our Mission</h3>
                                <span className='font-bold'>From Intent To AIM, From Obtaining to Becoming</span>
                                <div className='space-y-4'>
                                    <p className='text-justify'>
            ...
            <div className='bg-[#ecf4fc] mt-8 mb-16 py-18'>
                <div className='max-w-7xl mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-0'>
                        ...
                        <div>
                            <div className='content md:pl-4 pt-4 text-center md:text-start'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'>Thoughts</h3>
                                <span className='font-bold'>
