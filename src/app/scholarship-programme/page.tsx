                ...
                <div className='grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-0'>
                    <div>
                        <div className='content md:pr-4 md:pt-4 text-center md:text-start'>
                            ...
                            <p className='text-justify'>At Dikshant IAS, we believe that quality education and UPSC preparation should be accessible to all, regardless of economic or social background. To support deserving and hardworking aspirants, we proudly offer need-based and category-based scholarships.</p>
                            <p className='text-justify'>Dikshant Scholarship Program, is a welfare program run by Dikshant IAS under which free coaching is provided to socially and economically weaker students living in India. This program is funded by the Government of India and various other NGOs.</p>

                            <h3 className='font-bold mt-4'>Funded by the Government of India and NGOs.</h3>

                            <p className='text-justify'>To avail the benefits of the scholarship program, click on the button below and get yourself registered.</p>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center px-14 md:px-0'>
                        <div>
                            <div className='content text-center md:text-start md:pr-4 pt-4'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'>Important Notes</h3>
                                <ul className='space-y-2 list-disc text-start'>
                        ...
                        <div>
                            <div className='content md:pl-4 pt-4 text-center md:text-start'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'> How to Apply?</h3>
                                <ul className='space-y-2 list-disc text-start'>
                    ...
                    <div className='items-center text-center md:text-left px-2 md:px-0'>
                        <div>
                            <div className='content md:pr-4'>
                                <h3 className='text-2xl md:text-3xl lg:text-3xl font-bold text-gray-900 mb-4'>Empower your UPSC journey with Dikshant IAS – Where talent meets opportunity.</h3>
