...
const CoursePage = () => {
    ...
    return (
        <div>
            {/* Header */}
            <div className="container max-w-7xl mx-auto bg-blue-100 rounded-2xl py-8">
                        ...
                        {activeTab === 'description' && (
                            <div>
                                ...
                                <div className="bg-gray-50 rounded-lg mb-3">
                                    <h3 className="text-xl font-semibold text-gray-900">समाजशास्त्र (वैकल्पिक विषय) Foundation Course (Combo Pack)</h3>
                                    <h3 className="text-xl font-semibold text-gray-900">Sociology Foundation Course + Sociology Mentorship Programme</h3>
                                    <h3 className="text-xl font-semibold text-gray-900">Fees Offline in Installment is Rs. 40,000 & Fees One Time is Rs. 35,500</h3>
                                </div>

                                {/* Course Description */}
                                <div className="prose max-w-none mb-8">
                                    <p className="text-gray-900 mb-6 font-sm">
                                    ...
                                    <p className="text-gray-900 mt-4 mb-4 font-bold">
                                        समाजशास्त्र फाउंडेशन कोर्स के अंतर्गत समाजशास्त्र मुख्य परीक्षा (समाजशास्त्र के दोनों प्रश्न पत्र ) का गहन एवं विस्तृत अध्यापन शामिल.
                                    </p>
                                </div>
                                ...
                                <div className="prose max-w-none mb-8">
                                    <h3 className='font-bold text-lg mb-3'>समाजशास्त्र ही क्यों....</h3>
                                ...
                                <div className="mb-8">
                                    ...
                                    <h3 className='font-bold text-lg my-3'>सामान्य अध्ययन के पाठ्यक्रम के अंतर्गत शामिल.....</h3>
                                    <div>
                                        <ol className='text-gray-900'>
                                        ...
                                        <p className='text-gray-800 mb-10 mt-4'>Contact: 7428092240, 9312511015</p>
                                    </div>
                                </div>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="font-semibold">Keith Son</h4>
                                                ...
                                                <div className="text-sm text-gray-600 mb-2">Course Review</div>
                    ...
                    <div className="w-full lg:w-80">
                        <div className="lg:sticky lg:top-8">
                            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    <div className="text-3xl font-bold text-gray-900 mb-6">₹35000/ <del className='text-gray-400'>₹40000/</del></div>
                                    ...
                                    <div className="space-y-4 text-sm">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span>Enrolled: 391 students</span>
                                        </div>
                                        <div className="flex items-center gap-3">
